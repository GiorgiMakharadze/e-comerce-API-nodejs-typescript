...
/*!jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license*/ !(function (a, b) {
                ...
                if ((c = d.relative[a[i].type]))
                    ...
                    if (((c = d.filter[a[i].type].apply(null, a[i].matches)), c[u])) {
                        ...
                        return va(i > 1 && sa(m), i > 1 &&
                            qa(a
                                .slice(0, i - 1)
                                .concat({ value: " " === a[i - 2].type ? "*" : "" })).replace(Q, "$1"), c, e > i && wa(a.slice(i, e)), f > e && wa((a = a.slice(e))), f > e && qa(a));
                    }
                    m.push(c);
                }
            return sa(m);
                ...
                setup: function () {
                    return n.nodeName(this, "form")
                        ...
                        : void n.event.add(this, "click._submit keypress._submit", function (a) {
                            var b = a.target, c = n.nodeName(b, "input") || n.nodeName(b, "button")
                                ? n.prop(b, "form")
                                : void 0;
                            c &&
                                !n._data(c, "submit") &&
    ...
    (n.parseJSON = function (b) {
        ...
        return e &&
            !n.trim(e.replace(Gb, function (a, b, e, f) {
